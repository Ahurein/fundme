...
import { createCampaign, deleteCampaign, filterCampaigns, getAllCampaigns, getCampaign, initiateDonation, searchCampaigns, updateCampaign, verifyCampaign } from "./campaign.controller";
...
const campaignRoute = (router: IRouter) => {
    ...
    router.route("/campaign/search").post(searchCampaigns)
